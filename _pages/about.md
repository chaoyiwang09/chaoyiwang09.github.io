...
- **Sensor → embodiment** — from acoustic/visual sensing to edge-UAV research (**PERCH** / **STARE**).
...
<p class="demo-note">Left: CLEAR zero-shot subtitle removal. Right: OCC-MLLM occlusion reasoning. See <a href="/projects/">Projects</a>.</p>
...
- **Embodied intelligence and real-world deployment.** Occlusion-aware multimodal reasoning under motion, limited compute, and partial observability. *Projects:* [OCC-MLLM](/projects/#occ-mllm) · **PERCH** · **STARE**.
