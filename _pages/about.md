...
News
======
- **[Jul 28, 2026]** Submitted **[PERCH](/projects/#perch)** and **[STARE](/projects/#stare)** to **AAAI 2027** (*first author*) — embodied edge-UAV viewpoint navigation & risk-controlled commitment. [PDFs →](/projects/#perch)
...
Selected Highlights
======
- **AAAI 2027 (submitted)** — first-author embodied UAV pair: [PERCH](/projects/#perch) (viewpoint ObjectNav) · [STARE](/projects/#stare) (spend-to-verify commitment).
...
<p class="demo-note">Left: PERCH (viewpoint ObjectNav). Right: STARE (spend-to-verify). Both <strong>submitted to AAAI 2027</strong>. See <a href="/projects/">Projects</a>.</p>
...
- **Embodied intelligence and real-world deployment.** Occlusion-aware multimodal reasoning under motion, limited compute, and partial observability — closed on edge UAVs. *Papers:* [PERCH](/publication/2026-perch) · [STARE](/publication/2026-stare) (**submitted to AAAI 2027**, first author) · [OCC-MLLM](/projects/#occ-mllm).
